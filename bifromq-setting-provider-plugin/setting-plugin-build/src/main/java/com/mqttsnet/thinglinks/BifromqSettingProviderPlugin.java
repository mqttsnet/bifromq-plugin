...
public class BifromqSettingProviderPlugin extends BifroMQPlugin<BifromqSettingProviderContext> {
    private static final Logger log = LoggerFactory.getLogger(BifromqSettingProviderPlugin.class);
    ...
    public BifromqSettingProviderPlugin (BifroMQPluginDescriptor descriptor){
        super(descriptor);
