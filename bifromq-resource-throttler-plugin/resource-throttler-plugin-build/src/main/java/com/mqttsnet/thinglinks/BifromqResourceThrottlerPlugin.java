...
public class BifromqResourceThrottlerPlugin extends BifroMQPlugin<BifromqResourceThrottlerContext> {
    private static final Logger log = LoggerFactory.getLogger(BifromqResourceThrottlerPlugin.class);
    ...
    public BifromqResourceThrottlerPlugin (BifroMQPluginDescriptor descriptor){
        super(descriptor);
